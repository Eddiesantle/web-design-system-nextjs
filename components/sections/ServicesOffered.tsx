...
const ServicesOffered: React.FC<ServicesOfferedProps> = ({ title, description, services }) => {
    return (
        <div className="bg-[#0D4259] text-white">
            <ContainerDefault>
...
const ServicesList: React.FC<Pick<ServicesOfferedProps, 'services'>> = ({ services }) => (
    <div className='flex flex-col gap-6'>
        <h2 className="text-2xl">Serviços <span className='text-secondary font-semibold font-[family-name:var(--font-geist-sans)]'>Oferecidos</span></h2>
